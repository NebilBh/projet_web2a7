			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light top-header mb-2">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav nav-mega mx-auto">
						...
						<li class="nav-item">
<a class="nav-link" href="try.html">Try on glasses</a>						</li>
	...
	<main>
      ...
      <div id='JeeWidget'>
        ...
        <div id='JeeWidgetChangeModelContainer' class="changeModelContainer">
          Choisir un modele
          <button class='changeModelButton buttonChange1' onclick="JEEWIDGET.load('rayban_aviator_or_vertFlash')">RayBan Aviator</button>
          <button class='changeModelButton buttonChange1' onclick="JEEWIDGET.load('rayban_round_cuivre_pinkBrownDegrade')">Vakay</button>
          <button class='changeModelButton buttonChange2' onclick="JEEWIDGET.load('rayban_wayfarer_denimNoir_bleuMirroir')">Persol</button>        
        </div>
        <!-- BEGIN ADJUST NOTICE -->
