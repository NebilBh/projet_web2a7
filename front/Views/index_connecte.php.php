			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light top-header mb-2">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav nav-mega mx-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="try.php">Try on glasses</a>
						</li>
...
<?php
	...
	$req = $c->query ("SELECT * FROM produits"); 
										...
										<div class="product-googles-info googles">
											<div class="men-pro-item">
												<div class="men-thumb-item">
													<img src="images/<?php echo $product['image']; ?>" class="img-fluid" alt="">
													...
													<div class="info-product-price">
														<div class="grid_meta">
															<div class="product_price">
																<h4>
																	<a href="single.html"><?php echo $product['nom']; ?></a>
																</h4>
																<div class="grid-price mt-2">

																	<span class="money"><?php echo $product['prix']; echo('$'); ?></span>
																</div>
															</div>
															<ul class="stars">
																<li>
