		...
		<div class="container">
			...
			<div class="inner_sec">
				...
				if (isset($_GET['code']))
				{
				    ...
				    $result= $reclam->recupererReclamation('code',$_GET['code']);
						 ...
						 <div class="row contact_left_grid">
							<div class="col-md-6 con-left">
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" name="nom" placeholder="" required="required" value ="<?php echo $nom ?>">
								</div>

								<div class="form-group">
									<label class="my-2">Prénom</label>
									<input class="form-control" type="text" name="prenom" placeholder="" required="required" value ="<?php echo $prenom ?>">
								</div>

								<div class="form-group">
									<label>Email</label>
									<input class="form-control" type="email" name="mail" placeholder="" required="required" value ="<?php echo $mail?>">
								</div>
							...
							<div class="col-md-6 con-right">
								<div class="form-group">
									<label>Message</label>
									<textarea id="textarea" name ="message" placeholder="" required="required" value ="<?php echo $message?>"></textarea>
								</div>
...
<?PHP
	...
	if (isset($_GET['modifier']))
	{
		...
		$recl=new Reclamation($_GET['code'],$_GET['nom'],$_GET['prenom'],$_GET['mail'],$_GET['tel'],$_GET['sujet'],$_GET['message']);
