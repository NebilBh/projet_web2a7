                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Clients <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="gestionclient.php">Gérer les clients</a></li>
                    </ul>
                  </li>

				  <li><a><i class="fa fa-edit"></i> Cartes fidélités <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="gestioncarte.php">Gérer les cartes fidélités</a></li>
                    </ul>
                  </li>
