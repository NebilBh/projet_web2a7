...
if (isset($_POST['cin']) and isset($_POST['nom']) and isset($_POST['tel']) and isset($_POST['mail'])and isset($_POST['adresse'])and isset($_POST['ville'])){
$livraison1=new livraison($_POST['cin'],$_POST['nom'],$_POST['tel'],$_POST['mail'],$_POST['adresse'],$_POST['ville']);
//Partie2
/*
var_dump($employe1);
}
