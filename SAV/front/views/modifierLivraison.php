...
<body>
								...
								<li>
									<div class="row">
										<div class="col-md-4 media-list span4 text-left">
											...
											<ul>
												<li class="media-mini mt-3">
													<a href="contact.html">Envoyer une reclamation</a>
												</li>
												<li class="">
													<a href="Mcontact.html"> Modifier reclamation</a>
												</li>
												<li>
													<a href="Scontact.html">Supprimer reclamation</a>
												</li>
	...
	<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
		<div class="container">
			<h3 class="tittle-w3layouts text-center my-lg-4 my-4">Livraison</h3>
			<div class="inner_sec">
				<p class="sub text-center mb-lg-5 mb-3">Modifier vos informations</p>
	...
	<?PHP
				...
				if (isset($_GET['cin']))
				{
					...
					$reclam=new LivraisonC();
				    $result= $reclam->recupererLivraison('cin',$_GET['cin']);
						...
						<form method="get" >
						 ...
						 <div class="row contact_left_grid">
							<div class="col-md-6 con-left">
								...
								<div class="information-wrapper">
									<div class="first-row form-group">
										...
										<div class="card_number_grids">
											...
											<input class="billing-address-name form-control" type="text" name="nom" placeholder="" value ="<?php echo $nom ?>">
									...
									<!-- 	<div class="card_number_grids">
											...
											<input class="billing-address-name form-control" type="text" name="prenom" placeholder="PRENOM"value ="<?php echo $prenom ?>">
											...
											<div class="card_number_grid_left">
													...
													<input class="billing-address-name form-control" type="number" name="tel" placeholder=" " value ="<?php echo $tel ?>">
												
											</div>
											<div class="card_number_grid_left">
												
													<label class="control-label">Email @:</label>
													<input class="billing-address-name form-control" type="email" name="mail" placeholder=" " value ="<?php echo $mail ?>">
											...
											<div class="card_number_grid_right">
													...
													<input class="billing-address-name form-control" type="text" name="adresse" placeholder=""value ="<?php echo $adresse ?>">
								...
								<select name="ville"  id="AddressForm" value ="<?php echo $ville ?>">
	...
	<input class="submit check_out" type="submit" name="modifier" value="Modifer">										</div>
									</div>
...
<?PHP
	...
	if (isset($_GET['modifier']))
	{
		...
		$recl=new Livraison($_GET['cin'],$_GET['nom'],$_GET['tel'],$_GET['mail'],$_GET['adresse'],$_GET['ville']);
		$livraisonC = new LivraisonC();
		
		if($livraisonC->modifierLivraison($recl));
		{
			 GoToNow('shop.html');
