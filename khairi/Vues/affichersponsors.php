         ...
         <div class="right_col" role="main" >
            ...
            <div >
              <div class="title_left">
                <h3>Sponsors <small>Ajouter votre sponsors</small></h3>
              </div>

              <form method="POST" action="ajoutersponsors.php" enctype="multipart/form-data">
...
foreach($listesponsors as $row){
  ...
  <td><?PHP echo $row['renverssement']; ?></td>
   <td><img src="<?php echo 'images/sponsor/'.$row['image']; ?> " height="60" width="75" class="img-thumbnail" /></td>
