						 ...
						 <div class="row contact_left_grid">
							<div class="col-md-6 con-left">
								<div class="form-group">
									<label class="my-2">Entrez email pour supprimer la reclamation</label>
									<input class="form-control" type="email" name="mail" placeholder="" required=""  value="<?php echo $_SESSION['var']; ?>" >
								</div>
							
								<input class="form-control" type="submit" name="ajouter" value="supprimer">
