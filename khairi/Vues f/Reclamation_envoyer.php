						 ...
						 <div class="row contact_left_grid">
							<div class="col-md-6 con-left">
								...
								<div class="form-group">
									...
									<input class="form-control" type="email" name="mail" value="<?php echo $_SESSION['var']; ?>" placeholder="" required="">
								</div>

								<div class="form-group">
									<label>Numéro de téléphone</label>
									<input class="form-control" type="number-phone" name="tel" placeholder=""  max="8" min="8" required>
								</div>

								<div class="form-group">
								<label class="my-2">Categorie   :</label>
								<select name="categorie"  id="AddressForm">
								...
								<div class="form-group">
									<label>Sujet</label>
									<input class="form-control" type="text" name="sujet" placeholder="" required="">
								</div>
							</div>
							...
							<div class="col-md-6 con-right">
								...
								<div class="form-group">
									<label>Date</label>
									<input class="form-control" type="date" name="dater" placeholder="" required="">
								</div>
