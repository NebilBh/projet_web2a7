					...
					<div class="col-md-8 address_form">
						<h4>LIVRAISON</h4>
							<form method="POST" action="supprimerLivraison.php">
                               <caption>Annuler livraison</caption>
							<section class="creditly-wrapper wrapper">
								<div class="information-wrapper">
									<div class="first-row form-group">

										
											<label class="control-label">Entrez votre CIN pour annuler la livraison: </label>
											<input class="billing-address-name form-control" type="number" name="cin" placeholder="">										

								

<input class="submit check_out" type="submit" name="ajouter" value="Supprimer">		
</div>
</div>
